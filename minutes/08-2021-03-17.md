...
* SN has been asked to determine whether these operations best fit in the DIPI pipelines
...
* SN described a data integrity incident that was triggered by the recent launch of the partial update interface for biosamples
    * The root technical issue was a PHA user was able to update a special class of "blank" biosamples which made their way into the Elan sample manifest and were processed by Elan, one sample without metadata was published by Elan after completion
